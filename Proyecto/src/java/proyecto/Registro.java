...
public class Registro extends AbstractPageBean {
    ...
    public String enviarReg1_action() {
        // TODO: Process the button click action. Return value is a navigation 
        // case name where null will return to the same page.
        this.abrirConexion ();
        
        String nick = nickReg1.getText().toString();
        String pass = contraseñaReg1.getText().toString(); 
        String repass = contraseñaRepReg1.getText().toString();
        String email = emailReg1.getText().toString();
        
        // Comprobamos si los dos pass coinciden
        if (pass.equals(repass)) { 
            if (this.insertarUsu(nick,pass,email)) {
               return null; // pasar a la pagina siguiente

          }
        }
        
        // Inicializar formularios para un nuevo registro 
        nickReg1.setText(null);
        contraseñaReg1.setText(null);
        contraseñaRepReg1.setText(null);
        emailReg1.setText(null);
    ...
    public boolean insertarUsu(String nick, String pass, String email) { 
        try {
            st = con.createStatement();
            st.executeUpdate("Insert into usuario (nick, password, mail) values ('"
                    + nick + "', '" + pass + "', '" + email + "')");
