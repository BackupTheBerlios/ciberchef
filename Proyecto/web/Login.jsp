            ...
            <ui:html binding="#{Login.html1}" id="html1" lang="es">
                ...
                <ui:body binding="#{Login.body1}" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{Login.form1}" id="form1">
                        ...
                        <div class="section" style="background-image: url(./resources/lineas.gif); background-position: bottom; background-repeat: repeat-x">
                            <ui:panelLayout binding="#{Login.section}" id="section" style="height: 216px; position: relative; width: 360px; -rave-layout: grid">
                                <ui:staticText binding="#{Login.staticText1}" id="staticText1"
                                    style="padding: 20px 30px 20px 20px; background-image: url(./resources/postit.gif); background-repeat: no-repeat; height: 270px; left: 336px; top: 24px; position: absolute; width: 236px" text="Esto es una prueba de página de login.&#xa;Usuario:guest&#xa;Password:guest"/>
